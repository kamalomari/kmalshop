...
ob_start();
session_start();
$pageTitle="Order details purchase";//for function getTitle (default)
$noSlider ="";
include 'init.php';
            ...
            <div class="col-md-9 item-info">
                ...
                <? if ($item['Status_final'] === '0'){ ?>
                    <div class="panel panel-warning">
                        <div class="panel-heading">Successfully Buying</div>
                        <div class="panel-body">Purchased Is completed Please wait some day to receive item.</div>
                    </div>
                <? }else{ ?>
                    <div class="panel panel-success">
                        <div class="panel-heading">Success Receiving</div>
                        <div class="panel-body">receive item is successfully.</div>
                    </div>
                <?php }
                ?>
            </div>
