...
if (isset($_SESSION['Username'])) {
    ...
    if ($do == 'Manage') { // Manage Members Page
        ...
        if ($count > 0) { ?>
            ...
            $theMsg = "<div class='container'><div class='alert alert-danger'>Theres No Such ID</div>";
        ...
        if ($check > 0) {
            ...
            $theMsg = "<div class='container'><div class='alert alert-success'>" . $stmt->rowCount() . ' Record Approved</div></div>';
